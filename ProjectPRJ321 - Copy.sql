...
(N'Bí quyết vàng giúp quý ông mặc suit đẹp như ý',N'Việt Tùng',N'Muốn đầu tư một lần, mặc suốt đời, bạn nên ưu tiên các thiết kế suit cổ điển, ít lỗi mốt.','7.jpg', 1, '2019-03-24',1),
...
(N'Quy tắc dùng phụ kiện thời trang cho nam giới',N'Đình Duy',N'Ngoài chức năng xem giờ, đồng hồ đối với nam giới còn là món phụ kiện giúp làm tăng sự phong cách.','9.jpg', 3, '2019-03-24',1),
(N'Vì sao quý ông cần có ít nhất 1 chiếc trench coat trong đời?',N'Bá Dương',N'Đẹp bền bỉ theo thời gian, lại giúp mang lại vẻ nam tính, sang trọng nhất vẫn là các thiết kế trench coat cổ điển.','10.jpg', 4, '2019-03-24',1),
(N'Chảy nước miếng với 12 món bánh pancake "ngon chết người"',N'Chú heo con',N'Bạn sẽ không thể nào cưỡng lại được những chiếc bánh cực kỳ ngon mắt như thế này.','11.jpg', 5, '2019-03-24',1),
(N'Chiêm ngưỡng những món ăn cực kỳ dễ thương và ngộ nghĩnh (P.1)',N'Việt Tùng',N'Tiếp tục là những món ăn do các đầu bếp Nhật Bản chế biến, chúng sẽ mang lại cho bạn cảm giác "nhìn mà không nỡ ăn vì quá đẹp mắt".','12.jpg', 1, '2019-03-24',1),
(N'Chùm ảnh ấn tượng của những món ăn bị cắt làm đôi',N'Tuấn Anh',N'Một cách không thể thú vị hơn để khám phá phía bên trong của những món ăn thường ngày.','13.jpg', 2, '2019-03-24',1),
...
(N'Tổng hợp 20 chiếc bánh cupcake với cách trang trí độc đáo',N'Bá Dương',N'Những chiếc bánh cupcake vừa ngon lại còn được trang trí cầu kỳ khiến cho mọi người chỉ muốn được thưởng thức chúng ngay lập tức.','15.jpg', 4, '2019-03-24',1);
