<%-- 
    Document   : index
    Created on : Oct 19, 2019, 8:28:42 PM
    Author     : lpxed
--%>
...
<html lang="en">
    <head>
        ...
        <!-- Favicon -->
        <link rel="icon" href="media/fall.svg">
    ...
    <body>
                    ...
                    <div class="col-7 col-sm-6">
                        <div class="signup-search-area d-flex align-items-center justify-content-end">
                            <div class="login_register_area d-flex">
                                <div class="login">
                                    <a href="Register/register.jsp">Sing in</a>
                                </div>
                                <div class="register">
        ...
        <section class="welcome-post-sliders owl-carousel">
            ...
            <div class="welcome-single-slide">
                <!-- Post Thumb -->
                <img src="media/img/bg-img/slide-1.jpg" alt="">
                <!-- Overlay Text -->
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single_catagory wow fadeInUp" data-wow-delay=".3s">
                            <img src="media/img/catagory-img/1.jpg" alt="">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single_catagory wow fadeInUp" data-wow-delay=".6s">
                            <img src="media/img/catagory-img/2.jpg" alt="">
                            <div class="catagory-title">
                                <a href="#">
                                    <h5>Cooking</h5>
                                </a>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single_catagory wow fadeInUp" data-wow-delay=".9s">
                            <img src="media/img/catagory-img/3.jpg" alt="">
                            <div class="catagory-title">
                                <a href="#">
                                    <h5>Life Style</h5>
                                </a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="single-post wow fadeInUp" data-wow-delay=".2s">
                                    ...
                                    <div class="post-thumb">
                                        <img src="media/img/blog-img/1.jpg" alt="">
                                    </div>
                                    <!-- Post Content -->
                            ...
                            <div class="col-12 col-md-6">
                                <div class="single-post wow fadeInUp" data-wow-delay=".4s">
                                    <!-- Post Thumb -->
                                    <div class="post-thumb">
                                        <img src="media/img/blog-img/2.jpg" alt="">
                                    </div>
                                    <!-- Post Content -->
                                    <div class="post-content">
                                        <div class="post-meta d-flex">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="single-post wow fadeInUp" data-wow-delay=".6s">
                                    <!-- Post Thumb -->
                                    <div class="post-thumb">
                                        <img src="media/img/blog-img/3.jpg" alt="">
                                    </div>
                                    <!-- Post Content -->
                                    <div class="post-content">
                                        <div class="post-meta d-flex">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="single-post wow fadeInUp" data-wow-delay=".8s">
                                    <!-- Post Thumb -->
                                    <div class="post-thumb">
                                        <img src="media/img/blog-img/4.jpg" alt="">
                                    </div>
                                    <!-- Post Content -->
                                    <div class="post-content">
                                        <div class="post-meta d-flex">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="single-post wow fadeInUp" data-wow-delay="1s">
                                    <!-- Post Thumb -->
                                    <div class="post-thumb">
                                        <img src="media/img/blog-img/5.jpg" alt="">
                                    </div>
                                    <!-- Post Content -->
                                    <div class="post-content">
                                        <div class="post-meta d-flex">
                            ...
                            <div class="col-12">
                                <div class="list-blog single-post d-sm-flex wow fadeInUpBig" data-wow-delay=".2s">
                                    <!-- Post Thumb -->
                                    <div class="post-thumb">
                                        <img src="media/img/blog-img/6.jpg" alt="">
                                    </div>
                                    <!-- Post Content -->
                                    <div class="post-content">
                                        <div class="post-meta d-flex">
                            ...
                            <div class="col-12">
                                <div class="list-blog single-post d-sm-flex wow fadeInUpBig" data-wow-delay=".4s">
                                    <!-- Post Thumb -->
                                    <div class="post-thumb">
                                        <img src="media/img/blog-img/7.jpg" alt="">
                                    </div>
                                    <!-- Post Content -->
                                    <div class="post-content">
                                        <div class="post-meta d-flex">
                            ...
                            <div class="col-12">
                                <div class="list-blog single-post d-sm-flex wow fadeInUpBig" data-wow-delay=".6s">
                                    <!-- Post Thumb -->
                                    <div class="post-thumb">
                                        <img src="media/img/blog-img/8.jpg" alt="">
                                    </div>
                                    <!-- Post Content -->
                                    <div class="post-content">
                                        <div class="post-meta d-flex">
                            ...
                            <div class="col-12">
                                <div class="list-blog single-post d-sm-flex wow fadeInUpBig" data-wow-delay=".8s">
                                    <!-- Post Thumb -->
                                    <div class="post-thumb">
                                        <img src="media/img/blog-img/9.jpg" alt="">
                                    </div>
                                    <!-- Post Content -->
                                    <div class="post-content">
                                        <div class="post-meta d-flex">
        ...
        <div class="instargram_area owl-carousel section_padding_100_0 clearfix" id="portfolio">
            ...
            <div class="instagram_gallery_item">
                <!-- Instagram Thumb -->
                <img src="media/img/instagram-img/1.jpg" alt="">
                <!-- Hover -->
            ...
            <div class="instagram_gallery_item">
                <!-- Instagram Thumb -->
                <img src="media/img/instagram-img/2.jpg" alt="">
                <!-- Hover -->
                <div class="hover_overlay">
                    <div class="yummy-table">
                        <div class="yummy-table-cell">
        ...
        <!-- Jquery-2.2.4 js -->
        <script src="vendor/js/jquery/jquery-2.2.4.min.js"></script>
        <!-- Popper js -->
        <script src="vendor/js/bootstrap/popper.min.js"></script>
        <!-- Bootstrap-4 js -->
        <script src="vendor/js/bootstrap/bootstrap.min.js"></script>
        <!-- All Plugins JS -->
        <script src="vendor/js/others/plugins.js"></script>
        <!-- Active JS -->
        <script src="vendor/js/active.js"></script>
    </body>
