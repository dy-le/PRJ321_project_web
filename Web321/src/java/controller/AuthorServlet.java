 ...
 * @author Tuan Anh
 */
public class AuthorServlet implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("AuthorServlet:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("AuthorServlet:DoAfterProcessing");
        }
...
//                res.sendRedirect("/FilterSample/login.jsp");
//            }else{
//                session.setAttribute("error", null);
//                String url = req.getRequestURI().toString();
//                String context = req.getContextPath();
//                
//                String role = acc.getRoleAcc();
//                url = url.substring(url.indexOf(context) + context.length() + 1);
//                // /admin/... or /user/..
//                
//                if(!url.startsWith(role)){
//                    role = role.equals("admin")?"user":"admin";
//                    session.setAttribute("expired", "Your session has just expired " 
//                            + role + " role");
//                    res.sendRedirect("/FilterSample/login.jsp");
//                }
//            }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("AuthorServlet: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("AuthorServlet(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("AuthorServlet::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("AuthorServlet::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("AuthorServlet::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("AuthorServlet::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("AuthorServlet::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
